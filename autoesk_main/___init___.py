...
class NewSetPaths(Dirs, Now):
    ...
    @ classmethod
    def files_path(cls, pasta_client, insyear=get_compt_only, ano=None):
        """[summary]
        ...
        if isinstance(insyear, types.FunctionType):
    ...
    def excel_file_path(self, excelfolder='__EXCEL POR COMPETENCIAS__', fncompt=None):
        ...
        Args:
            ...
            fncompt ([type], optional): filename. Defaults to None (compt).
        """
        if fncompt is None:
...
filepath = a.getset_folderspath()
print(filepath)
CRIA_DEFIS_2021 = a.files_path('cliente_teste', 'DEFIS_2021')
print(CRIA_DEFIS_2021)
# print(b)
# a.pathit()
